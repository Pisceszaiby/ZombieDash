...
def main_game():
    ...
    button3=Button(zombie,bg="lightblue",font=("Chiller",'18','bold'),text="LEVEL 3",command=lambda:change_click('rockpapersci'))
    button3.place(x=340,y=488)
    button4=Button(zombie,bg="lightblue",font=("Chiller",'18','bold'),text="LEVEL 4",command=lambda:change_click('password'))
    button4.place(x=520,y=200)
    button1=Button(zombie,bg="lightblue",font=("Chiller",'18','bold'),text="LEVEL 1",command=lambda:change_click('quiz'))
    button1.place(x=80,y=457)
    button2=Button(zombie,bg="lightblue",font=("Chiller",'18','bold'),text="LEVEL 2",command=lambda:change_click('deck'))
...
name=Label(user_window , bg='lightblue',font=("Chiller",'20','bold'),text='Enter Your Name:')
name.place(x=250,y=60)
entry=Entry(user_window , bg='lightblue',fg='blue',font=("Chiller",'20','bold'))        #to get name from player
